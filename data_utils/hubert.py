...
wav2vec2_processor = Wav2Vec2Processor.from_pretrained("data_utils/facebook/")
print("Loading the HuBERT Model...")
hubert_model = HubertModel.from_pretrained("data_utils/facebook/")
...
parser.add_argument('--wav', type=str, help='path to aud.wav, e.g. data/May/aud.wav')
